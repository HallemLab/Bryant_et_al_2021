function [maxdisplacement, pathlength, meanspeed, instantspeed, displacement] = TT_displace(pt,xvals, yvals)
%TT_displace calculates the euclidean distance between a two sets of x/y
%   coordinates. Specifically written to calculate the distance between a
%   series of coordinates and a starting point.
%
%   [maxdisplacement, pathlength, meanspeed, instantspeed, displacement] =
%   TT_displace(pt,xvals, yvals)
%   
%   Inputs:
...
%   2-21-20     Realized that this is different than the chemotaxis
%   version, so now it's named to avoid path confusion.
%   
%% Code
